...
export const SideBar = ({fmodal}) => {
    ...
    return (
        ...
        <section className={`${clases}`}>
            ...
            <img onClick={()=>{fmodal();if( window.innerWidth < 540 )handlerActivar();}}  className='object-cover w-[25%] h-auto invert-75 hover:invert-100 cursor-pointer'src={agregarIcon} alt="" />
        </section>
